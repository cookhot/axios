...
function Axios(instanceConfig) {
  ...
  // 这里变为 this.defaults = utils.merge(defaults, instanceConfig) 会更好，后面使用request调用方法的时候
  // 不需要utils.merge(defaults, this.defaults, config); 而是utils.merge(this.defaults, config)
